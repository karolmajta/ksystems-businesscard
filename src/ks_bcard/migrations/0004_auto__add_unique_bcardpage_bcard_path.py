...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'BCardPage', fields ['bcard', 'path']
        db.create_unique('ks_bcard_bcardpage', ['bcard_id', 'path'])


    def backwards(self, orm):
        # Removing unique constraint on 'BCardPage', fields ['bcard', 'path']
        db.delete_unique('ks_bcard_bcardpage', ['bcard_id', 'path'])
    ...
    models = {
        ...
        'ks_bcard.bcardpage': {
            'Meta': {'unique_together': "(('bcard', 'path'),)", 'object_name': 'BCardPage'},
        ...
        'ks_bcard.bcardsite': {
            'Meta': {'unique_together': "(('user', 'name'),)", 'object_name': 'BCardSite'},
            ...
            'template': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['dbtemplates.Template']", 'unique': 'True', 'null': 'True', 'blank': 'True'}),
