...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'BCardSite', fields ['user', 'name']
        db.create_unique('ks_bcard_bcardsite', ['user_id', 'name'])


    def backwards(self, orm):
        # Removing unique constraint on 'BCardSite', fields ['user', 'name']
        db.delete_unique('ks_bcard_bcardsite', ['user_id', 'name'])
